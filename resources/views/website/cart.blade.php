                                ...
                                <tbody>
                                    ...
                                    <tr class="cart_item">
                                        ...
                                        <td class="cart_quantity">
                                            <div class="input-group mb-3" style="max-width: 120px;">
                                                <div class="input-group-prepend">
                                                    <button type='button' value='-' class='btn btn-outline-primary quantityminus ' field='quantity'>&minus;</button>
                                                </div>
                                                <input type='text' name='quantity' value='1' class='form-control quantity' />
                                                <div class="input-group-append">
                                                    <button type='button' value='+' class='btn btn-outline-primary quantityplus ' field='quantity'>&plus;</button>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="cart_total">
                    ...
                    <div class="col-md-6 pl-5">
                        <div class="row justify-content-end">
                            <div class="col-md-7">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <button class="btn btn-primary btn-lg btn-block" onclick="window.location='{{ route('website.checkout') }}'">Proceed To
                      Checkout</button>
                                    </div>
                                </div>
                            </div>
