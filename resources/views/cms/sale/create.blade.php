...
@section('main-title' , 'Create Sale')

@section('sub-title' , 'create sale')
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Create Data of Sale</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form>
              ...
              <div class="card-body">
                <div class="row">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="price" name="price" placeholder="Price of the Medicine" class="form-control">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" class="form-control" name="date" id="date" placeholder="Enter  Date of midicine">
                      </div>
...
<script>
  function performStore(){
    ...
    store('/cms/admin/sales',formData );
